...
class OpenRiskWindow(models.TransientModel):
    ...
    pending_docum_debi = fields.Integer('Document Debit Pending', readonly="True")
    pending_docum_cred = fields.Integer('Document Credit Pending', readonly="True")
    pending_docum_draft = fields.Integer('Document Draft Pending', readonly="True")
    pending_credit_days = fields.Integer('Credit Days Pending', readonly="True")    
